...
{#* section 16.1 Multiple interpolation ####
  load(file="G:/paper_2_PD&DM/data_DC/Clearn_data_new.Rdata")
...
colnames(Clearn_data_new)
table(Clearn_data_new$HPL_status,useNA = "ifany")
table(Clearn_data_new$HTN_status,useNA = "ifany")
Clearn_data_new$BMI[Clearn_data_new$BMI==8888]<-NA
Interpolation_data_new<-cbind(Interpolation_data,Clearn_data_new[,c("HTN_status","HPL_status")])
Interpolation_data_new$ID<-Clearn_data_new$ID
Interpolation_data_new$BMI<-Clearn_data_new$BMI
mice_data_new<-Interpolation_data_new
mice::md.pattern(mice_data_new)
sapply(data, function(x) sum(is.na(mice_data_new)))
mice_data_new$I<-NULL
init_new = mice(mice_data_new,maxit= 10, m=10,seed = 500) 
save(init_new,file="G:/paper_2_PD&DM/data_DC/mice_data_new.Rdata")
load(file="G:/paper_2_PD&DM/data_DC/mice_data_new.Rdata")
mice_data_new <- complete(init_new,10)
Interpolation_data_new$HPL_status<-mice_data_new$HPL_status
Interpolation_data_new$BMI<-mice_data_new$BMI
save(Interpolation_data_new,file="G:/paper_2_PD&DM/data_DC/Interpolation_data_new.Rdata")
...
var<-c("MORT_stat","Age_status","Gender","Race_ethnicity","Education_levels","PIR",
         ...
         "BMI_Grade","CVD_status","Cancer_status","Br_diabetes_status","HTN_status","HPL_status",
...
VAR_ALL<-c("MORT_stat","WBC","CAL_mean","PPD_mean","DMFT","Age","Age_status","Gender","Race_ethnicity","Education_levels","PIR",
             ...
             "HbA1c","HbA1c_status","duration_status","HTN_status","HPL_status","duration_status","Medicine_use")
...
# >>>>> section 20 All-cause and cause-specific mortality (Table 2) ####  
  ...
  { #* Combine #####
    ...
    write.table(Table2,sep = ",",file ="G:/paper_2_PD&DM/data_DC/Table2.csv")
  }
...
{ #* Data Collation #####
    ...
    ALL_Weight_plus<-Interpolation_weighted[,c("PD_diagnosis","MORT_stat","CVD_MORT_stat","CVD_status","peryear",
                                               ...
                                               "BMI_Grade","Smoking_status","Drinking_status","HEI","Medicine_use","HbA1c_status")]
    ...
    #Medicine
    ALL_Weight_plus$Medicine_sub<-factor(ALL_Weight_plus$Medicine_use,
                                    levels = c("NO","YES"))
    table(ALL_Weight_plus$Medicine_sub)
    #HbA1c_sub
    ALL_Weight_plus$HbA1c_sub<-factor(ALL_Weight_plus$HbA1c_status,
                                         levels = c("HbA1c<7","HbA1c>=7"))
    table(ALL_Weight_plus$HbA1c_sub)
    #RACE
...
{ #* AGE #####
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Gender+
                                ...
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_45)
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Gender+
                                Race_ethnicity+SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_45_CVD)
    Age45<-summary(MODEL_ALL_inter)
    P<-Age45[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(Age45[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Gender+
                                Race_ethnicity+SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_80)
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Gender+
                                Race_ethnicity+SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_80_CVD)
    Age80<-summary(MODEL_ALL_inter)
    P<-Age80[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(Age80[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_sub+PD_diagnosis*Age_sub+Gender+
                                Race_ethnicity+SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy)
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_sub+PD_diagnosis*Age_sub+Gender+
                                Race_ethnicity+SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_CVD)
...
{ #* RACE #####
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_white)
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_white_CVD)
    Racewhite<-summary(MODEL_ALL_inter)
    P<-Racewhite[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(Racewhite[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_Other)
    Racewhite<-summary(MODEL_ALL_inter)
    P<-Racewhite[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(Racewhite[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_Other_CVD)
    Racewhite<-summary(MODEL_ALL_inter)
    P<-Racewhite[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(Racewhite[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
...
{#* gender #####
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+
                                SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_Female)
    Racewhite<-summary(MODEL_ALL_inter)
    P<-Racewhite[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(Racewhite[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+
                                SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_Female_CVD)
    Racewhite<-summary(MODEL_ALL_inter)
    P<-Racewhite[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(Racewhite[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+
                                SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_Male)
    Racewhite<-summary(MODEL_ALL_inter)
    P<-Racewhite[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(Racewhite[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+
                                SES+
                                Smoking_status+Drinking_status+HEI+
                                BMI_Grade+Medicine_use+HbA1c_status, design =rhcSvy_Male_CVD)
...
{#* BMI #####
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+Medicine_use+HbA1c_status
                              , design =rhcSvy_low0)
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_low0_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_high0)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_high0_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+BMI_sub+PD_diagnosis*BMI_sub+Age_status+Race_ethnicity+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy)
    MODEL<-summary(MODEL_ALL_inter)
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+BMI_sub+PD_diagnosis*BMI_sub+Age_status+Race_ethnicity+Gender+
                                SES+
                                Smoking_status+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
...
{#* Smoking_sub #####
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_Current)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_Current_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_Never)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_Never_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Smoking_sub+PD_diagnosis*Smoking_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Smoking_sub+PD_diagnosis*Smoking_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
...
{#* Drinking_sub #####
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+BMI_Grade+HEI+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_nondrinker)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+HEI+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_nondrinker_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+HEI+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_drinker)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    Drinking_sub3
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+BMI_Grade+HEI+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_drinker_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Drinking_sub+PD_diagnosis*Drinking_sub+Race_ethnicity+Gender+
                                Age_status+SES+BMI_Grade+HEI+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Drinking_sub+PD_diagnosis*Drinking_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+HEI+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
...
{#* SES #####
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                Smoking_status+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_low)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                Smoking_status+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_high)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                Smoking_status+
                                BMI_Grade+Drinking_status+HEI+Medicine_use+HbA1c_status, design =rhcSvy_high_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
...
{#*HEI #####
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_HEI1_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_HEI2)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_HEI2_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+HEI_sub+PD_diagnosis*HEI_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+HEI_sub+PD_diagnosis*HEI_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HbA1c_status, design =rhcSvy_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
...
{#*Medicine #####
    rhcSvy_Medicine1<-subset(rhcSvy,Medicine_sub=="NO")
    rhcSvy_Medicine1_CVD<-subset(rhcSvy,Medicine_sub=="NO"&CVD_status=="NO")
    rhcSvy_Medicine2<-subset(rhcSvy,Medicine_sub=="YES")
    rhcSvy_Medicine2_CVD<-subset(rhcSvy,Medicine_sub=="YES"&CVD_status=="NO")
    svytable(~CVD_MORT_stat+Medicine_sub,rhcSvy_Medicine1_CVD)
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+HEI+HbA1c_status, design =rhcSvy_Medicine1_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    Medicine_sub2
    Medicine_sub.all<-rbind(Medicine_sub1,Medicine_sub2)
    Medicine_sub.all
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+HEI+HbA1c_status, design =rhcSvy_Medicine2)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+HEI+HbA1c_status, design =rhcSvy_Medicine2_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    ...
    Medicine_sub4
    Medicine_sub.all<-rbind(Medicine_sub.all,Medicine_sub3,Medicine_sub4)
    Medicine_sub.all
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Medicine_sub+PD_diagnosis*Medicine_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+Drinking_status+Smoking_status+HEI+HbA1c_status, design =rhcSvy)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
    Medicine_sub5<- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
                          'P value' =P,'subgroup'="Medicine_sub","group"="interaction",'status'="all cause")
    Medicine_sub.all<-rbind(Medicine_sub.all,Medicine_sub5)
    Medicine_sub.all
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Medicine_sub+PD_diagnosis*Medicine_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+Drinking_status+Smoking_status+HEI+HbA1c_status, design =rhcSvy_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
    Medicine_sub6<- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
                          'P value' =P,'subgroup'="Medicine_sub","group"="interaction",'status'="CVD cause")
    Medicine_sub.all<-rbind(Medicine_sub.all,Medicine_sub6)
    Medicine_sub.all
}
  {#*HbA1c #####
    rhcSvy_HbA1c1<-subset(rhcSvy,HbA1c_sub=="HbA1c<7")
    rhcSvy_HbA1c1_CVD<-subset(rhcSvy,HbA1c_sub=="HbA1c<7"&CVD_status=="NO")
    rhcSvy_HbA1c2<-subset(rhcSvy,HbA1c_sub=="HbA1c>=7")
    rhcSvy_HbA1c2_CVD<-subset(rhcSvy,HbA1c_sub=="HbA1c>=7"&CVD_status=="NO")
    svytable(~CVD_MORT_stat+HbA1c_sub,rhcSvy_HbA1c1_CVD)
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
    ...
    HbA1c_sub1 <- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
                           'P value' =P,'subgroup'="HbA1c_sub","group"="YES",'status'="all cause")
    HbA1c_sub1
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HEI, design =rhcSvy_HbA1c1_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    HbA1c_sub2<- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
                          'P value' =P,'subgroup'="HbA1c_sub","group"="YES",'status'="CVD cause")
    HbA1c_sub2
    HbA1c_sub.all<-rbind(HbA1c_sub1,HbA1c_sub2)
    HbA1c_sub.all
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HEI, design =rhcSvy_HbA1c2)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    HbA1c_sub3 <- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
                           'P value' =P,'subgroup'="HbA1c_sub","group"="NO",'status'="all cause")
    HbA1c_sub3
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+Age_status+Race_ethnicity+Gender+
                                SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HEI, design =rhcSvy_HbA1c2_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][1,"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
    HbA1c_sub4<- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
                          'P value' =P,'subgroup'="HbA1c_sub","group"="NO",'status'="CVD cause")
    HbA1c_sub4
    HbA1c_sub.all<-rbind(HbA1c_sub.all,HbA1c_sub3,HbA1c_sub4)
    HbA1c_sub.all
    MODEL_ALL_inter<-svycoxph(Surv(peryear, MORT_stat==1) ~PD_diagnosis+HbA1c_sub+PD_diagnosis*HbA1c_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HEI, design =rhcSvy)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
    HbA1c_sub5<- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
                          'P value' =P,'subgroup'="HbA1c_sub","group"="interaction",'status'="all cause")
    HbA1c_sub.all<-rbind(HbA1c_sub.all,HbA1c_sub5)
    HbA1c_sub.all
    MODEL_ALL_inter<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~PD_diagnosis+HbA1c_sub+PD_diagnosis*HbA1c_sub+Race_ethnicity+Gender+
                                Age_status+SES+
                                BMI_Grade+Drinking_status+Smoking_status+Medicine_use+HEI, design =rhcSvy_CVD)
    MODEL<-summary(MODEL_ALL_inter)
    P<-MODEL[["coefficients"]][length(MODEL_ALL_inter[["coefficients"]]),"Pr(>|z|)"]
    HR<-as.numeric(MODEL[["conf.int"]][length(MODEL_ALL_inter[["coefficients"]]),c("exp(coef)","lower .95","upper .95")])
    HbA1c_sub6<- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
                          'P value' =P,'subgroup'="HbA1c_sub","group"="interaction",'status'="CVD cause")
    HbA1c_sub.all<-rbind(HbA1c_sub.all,HbA1c_sub6)
    HbA1c_sub.all
  }
all.subgroup<-rbind(Age.all,Race.all,Gender.all,BMI.all,Smoke.all,Drinking_sub.all,SES.all,HEI_sub.all,Medicine_sub.all,HbA1c_sub.all)
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 24 Sensitivity Analysis 1 CAL (Table S3-1) ####  
load(file="G:/paper_2_PD&DM/data_DC/Interpolation_weighted.Rdata")
colnames(Interpolation_weighted)
rhcSvy <- svydesign(id = ~sdmvpsu,nest = TRUE, data =Interpolation_weighted,strata=~sdmvstra,weights = ~ weight)
{ #* all model #####
...
{ #* Combine #####
  ...
  write.table(TableS3_1,sep = ",",file ="G:/paper_2_PD&DM/data_DC/TableS3_1.csv")
}

# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 25 Sensitivity Analysis 1 PPD (Table S3-2) ####  
load(file="G:/paper_2_PD&DM/data_DC/Interpolation_weighted.Rdata")
colnames(Interpolation_weighted)
rhcSvy <- svydesign(id = ~sdmvpsu,nest = TRUE, data =Interpolation_weighted,strata=~sdmvstra,weights = ~ weight)
{ #* all model #####
...
{ #* Combine #####
  ...
  write.table(TableS3_2,sep = ",",file ="G:/paper_2_PD&DM/data_DC/TableS3_2.csv")
}


# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 26 Sensitivity Analysis 1 DMFT (Table S4) ####  
load(file="G:/paper_2_PD&DM/data_DC/Interpolation_weighted.Rdata")
colnames(Interpolation_weighted)
rhcSvy <- svydesign(id = ~sdmvpsu,nest = TRUE, data =Interpolation_weighted,strata=~sdmvstra,weights = ~ weight)
{ #* all model #####
...
{ #* Combine #####
  ...
  result.all.cause$upper..95<-round(result.all.cause$upper..95,2)
  result.all.cause$P.value<-round(result.all.cause$P.value,3)
  Table_S5<-result.all.cause
  write.table(Table_S5,sep = ",",file ="G:/paper_2_PD&DM/data_DC/Table_S5.csv")
}
...
TableS7<-cbind(Over_all,noPD[,c("counts","Mean","SE")],PD[,c("counts","Mean","SE")])
...
TableS7<-merge(TableS7,test_data,by="Covariates",all = T)
...
TableS9<-cbind(Over_all,noPD[,c("counts","Mean","SE")],PD[,c("counts","Mean","SE")])
...
TableS9<-merge(TableS9,test_data,by="Covariates",all = T)
...
{ #* Combine #####
  ...
  result.all.cause$upper..95<-round(result.all.cause$upper..95,2)
  result.all.cause$P.value<-round(result.all.cause$P.value,3)
  Table_S10<-result.all.cause
  write.table(Table_S10,sep = ",",file ="G:/paper_2_PD&DM/data_DC/Table_S10.csv")
}
...
# >>>>> section 33 Kaplan-Meier (Figure 1) ####
  ...
  { #* ALL Mortality Figure 1A ####
    ...
    Figure_2A<-ggsurvplot(FIT_ALL_PD,conf.int =TRUE, tables.theme = theme_cleantable(), palette=c("#5F97D2", "#F0988C"), 
...
{#* CVD mortarity ####
  ...
  {#** PPD_mean ####
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    points(2.52,1,pch=16,cex=1)
    text(refvalue, 1.5, paste0("ref value = ","1.59")) 
    legend("topright",
           paste0(
                  "\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
...
{#* Cancer mortarity ####
  ...
  {#** PPD_mean ####
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 1.2, paste0("ref value = ","1.60")) 
    legend("topright",
           paste0("\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
    dev.off()
...
{#* DM mortarity ####
  ...
  {#** PPD_mean ####
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 1.5, paste0("ref value = ","1.58")) 
    legend("topright",
           paste0("\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
    dev.off()
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
## >>>>> section 27 RCS for DMFT (Figure S5) ####
setwd("G:/paper_2_PD&DM/data_DC")
load(file="G:/paper_2_PD&DM/data_DC/Interpolation_weighted.Rdata")
RCS <- Interpolation_weighted
{#* All cause mortarity ####
  {#** DMFT ####
    pdf("Figure_S5A.pdf",width=6,height=5)
...
{#* CVD mortarity ####
  ...
  RCS$CVD_MORT_stat<-as.numeric(RCS$CVD_MORT_stat)
  {#** DMFT CVD ####
    pdf("Figure_S5B.pdf",width=6,height=5)
    limUp<-3*IQR(RCS[,"DMFT"],na.rm = T)+quantile(RCS[,"DMFT"],3/4,na.rm=T,names=F)
    limDown<-quantile(RCS[,"DMFT"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"DMFT"],na.rm = T)
    RCS<- RCS[!RCS[,"DMFT"]>=limUp&!RCS[,"DMFT"]<=limDown,]
    # limUp<-3*IQR(RCS[,18],na.rm = T)+quantile(RCS[,18],3/4,na.rm=T,names=F)
...
{#* Cancer mortarity ####
  ...
  RCS$Cancer_MORT_stat<-as.numeric(RCS$Cancer_MORT_stat)
  {#** DMFT ####
    pdf("Figure_S5C.pdf",width=6,height=5)
    limUp<-3*IQR(RCS[,"DMFT"],na.rm = T)+quantile(RCS[,"DMFT"],3/4,na.rm=T,names=F)
    limDown<-quantile(RCS[,"DMFT"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"DMFT"],na.rm = T)
    RCS<- RCS[!RCS[,"DMFT"]>=limUp&!RCS[,"DMFT"]<=limDown,]
    # limUp<-3*IQR(RCS[,18],na.rm = T)+quantile(RCS[,18],3/4,na.rm=T,names=F)
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue + 1, 2, paste0("ref value = ",refvalue)) 
    legend("topright",
           paste0(
             "\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
...
{#* DM mortarity ####
  ...
  RCS$DM_MORT_stat<-as.numeric(RCS$DM_MORT_stat)
  {#** DMFT ####
    pdf("Figure_S5D.pdf",width=6,height=5)
    limUp<-3*IQR(RCS[,"DMFT"],na.rm = T)+quantile(RCS[,"DMFT"],3/4,na.rm=T,names=F)
    limDown<-quantile(RCS[,"DMFT"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"DMFT"],na.rm = T)
    RCS<- RCS[!RCS[,"DMFT"]>=limUp&!RCS[,"DMFT"]<=limDown,]
    # limUp<-3*IQR(RCS[,18],na.rm = T)+quantile(RCS[,18],3/4,na.rm=T,names=F)
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 20 All-cause and cause-specific mortality (Table S?) ####  
load(file="G:/paper_2_PD&DM/data_DC/Interpolation_weighted.Rdata")
colnames(Interpolation_weighted)
rhcSvy <- svydesign(id = ~sdmvpsu,nest = TRUE, data =Interpolation_weighted,strata=~sdmvstra,weights = ~ weight)
{ #* all model #####
  model3_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         PD_diagnosis+Age_status+Gender+Race_ethnicity+SES+
                         Smoking_status+Drinking_status+HEI+BMI_Grade+WBC, design =rhcSvy)
  model3_all_result<-summary(model3_all)
  P<-model3_all_result[["coefficients"]][1,"Pr(>|z|)"]
  HR<-as.numeric(model3_all_result[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
  result3 <- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
...
{ #* CVD model #####
  ...
  model3_CVD<-svycoxph(Surv(peryear, CVD_MORT_stat==1) ~
                         PD_diagnosis+Age_status+Gender+Race_ethnicity+SES+
                         Smoking_status+Drinking_status+HEI+BMI_Grade+WBC, design =rhcSvy_DM_CVD)
  model3_CVD_result<-summary(model3_CVD)
  P<-model3_CVD_result[["coefficients"]][1,"Pr(>|z|)"]
  HR<-as.numeric(model3_CVD_result[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
  result3.CVD <- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
...
{ #* Cancer model #####
  ...
  model3_Cancer<-svycoxph(Surv(peryear, Cancer_MORT_stat==1) ~
                            PD_diagnosis+Age_status+Gender+Race_ethnicity+SES+
                            Smoking_status+Drinking_status+HEI+BMI_Grade+WBC,design =rhcSvy_DM_Cancer)
  model3_Cancer_result<-summary(model3_Cancer)
  P<-model3_Cancer_result[["coefficients"]][1,"Pr(>|z|)"]
  HR<-as.numeric(model3_Cancer_result[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
  result3.Cancer <- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
...
{ #* Combine #####
  ...
  result.all.cause$upper..95<-round(result.all.cause$upper..95,2)
  result.all.cause$P.value<-round(result.all.cause$P.value,3)
  TableS12<-result.all.cause
  TableS12
  write.table(TableS12,sep = ",",file ="G:/paper_2_PD&DM/data_DC/TableS12.csv")
}
