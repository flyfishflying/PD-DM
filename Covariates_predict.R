...
{#** section 8.6 HEI  ####
    ...
    HEI=read.table("G:/paper_2_PD&DM/data/NHANESIII/hei.dat",sep=",",fill=T)
    ...
    load("G:/paper_2_PD&DM/data_DC/III_baseline.Rdata")
...
save(Covariates_III,file="G:/paper_2_PD&DM/data_DC/covariates_III.Rdata")
...
{#** section 9.6 HEI  ####
    ...
    load("G:/paper_2_PD&DM/data_DC/CON1_baseline.Rdata")
...
save(Covariates_CON1,file="G:/paper_2_PD&DM/data_DC/Covariates_CON1.Rdata")
...
{#** section 10.6 HEI  ####
    ...
    colnames(CON_HEI)[1]<-"SEQN"
    load("G:/paper_2_PD&DM/data_DC/CON2_baseline.Rdata")
...
save(Covariates_CON2,file="G:/paper_2_PD&DM/data_DC/Covariates_CON2.Rdata")
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
{#* section 11.2 CRP  ####
  ...
  save(CRP,file="G:/paper_2_PD&DM/data_DC/CRP.Rdata")
}
...
{#*** section 12.1 NHANES III  ####
  ...
  save(Weight_III,file="G:/paper_2_PD&DM/data_DC/Weight_III.Rdata")
}
{#*** section 12.2 NHANES 1999-2004  ####
  ...
  save(Weight_CON1,file="G:/paper_2_PD&DM/data_DC/Weight_CON1.Rdata")
}
{#*** section 12.3 NHANES 2009-2014  ####
  load(file="G:/paper_2_PD&DM/data/covariates/CON_covariates_09.Rdata")
  ...
  save(Weight_CON2,file="G:/paper_2_PD&DM/data_DC/Weight_CON2.Rdata")
}
...
{#* section 13.4 merge all data ####
  ...
  save(All_data,file="G:/paper_2_PD&DM/data_DC/All_data.Rdata")
}

# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 14. Data clearn <<<<< ####

load(file="G:/paper_2_PD&DM/data_DC/All_data.Rdata")
table(All_data$T2D)
All_data$T2D<-NULL
...
colname<-colnames(Clearn_data)[14:36]
colname
Characters<-colApply(Clearn_data[,c(1,10:36)],colname, as.factor)
#as.numeric
...
save(Clearn_data,file="G:/paper_2_PD&DM/data_DC/Clearn_data.Rdata")
save(Characters,file="G:/paper_2_PD&DM/data_DC/Characters.Rdata")
